...
<md-toolbar class="">
    <div class="md-toolbar-tools" layout-align="space-between center">
        <div><md-icon md-svg-icon="small:library-books" class="s18"></md-icon> {{totalQty()}}</div>
        <div><md-icon md-svg-icon="small:star" class="s18"></md-icon> {{totalPoints()}}</div>
        <div>{{totalPrice()}}<md-icon md-svg-icon="small:currency-rub" class="s18"></md-icon></div>
    </div>
</md-toolbar>
</div>